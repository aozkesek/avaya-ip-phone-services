...
public class IppsWebApplicationInitializer implements WebApplicationInitializer {
	...
	public static void setIppsWebApplicationContext(
			WebApplicationContext ippsWebApplicationContext) {
		IppsWebApplicationInitializer.ippsWebApplicationContext = 
				ippsWebApplicationContext;
	}
