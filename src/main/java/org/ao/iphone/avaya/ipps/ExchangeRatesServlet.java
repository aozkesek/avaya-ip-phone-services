...
public class ExchangeRatesServlet extends AbstractBaseServlet {
	...
	public void service(ServletRequest request, ServletResponse response) 
		...
		String wml = readAllText("/exchangeRates-wml.xml")
				.replace("/_DATE_/", now.toString());
		
		RestTemplate restTemp = new RestTemplate();
		String xrates = restTemp
				.getForObject("http://www.tcmb.gov.tr/kurlar/today.xml", String.class);
		
		String strippedRates = xrates.replace("\r", " ")
				.replace("\n", "");
		...
		xrates = strippedRates.substring(sPos, ePos)
				...
				.replace("<ForexBuying>", "<p>FxBuy/Sell ")
				.replace("</ForexBuying>", "")
				.replace("<ForexSelling>", " / ")
				.replace("</ForexSelling>", "</p>")
				.replace("<BanknoteBuying>", "<p>BnBuy/Sell ")
				.replace("</BanknoteBuying>", "")
				.replace("<BanknoteSelling>", " / ")
				.replace("</BanknoteSelling>", "</p>");
